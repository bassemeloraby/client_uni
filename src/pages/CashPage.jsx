...
import { FaMoneyBillWave, FaArrowLeft, FaFileInvoice, FaStore, FaUser, FaUsers, FaCalendarAlt, FaBox, FaDollarSign } from 'react-icons/fa';
...
const CashPage = () => {
  ...
  const fetchSales = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const res = await customFetch.get('detailed-sales/cash-detailed', {
        params: {
          limit: pageSize,
      ...
      if (res.data?.success) {
        ...
        setError(res.data?.message || 'Failed to load sales');
      }
    } catch (err) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <Link to="/cash/statistics" className="btn btn-primary btn-sm ml-2">
          Cash Statistics
        </Link>
      </div>
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-primary">Cash Sales (Cash Customer Names)</h1>
          </div>
          <p className="text-base-content/70 mb-4">
            Showing detailed sales where CustomerName is one of the configured cash customer names.
          </p>
                  ...
                  {sales.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="13" className="text-center py-8">
                        <p className="text-base-content/70">No sales found for the selected cash customer names.</p>
                      </td>
                    </tr>
                  )}
                </tbody>
