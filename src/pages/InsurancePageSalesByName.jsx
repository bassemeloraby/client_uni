...
import { FaShieldAlt, FaArrowLeft, FaUser, FaDollarSign, FaShoppingCart, FaBox, FaChartBar } from 'react-icons/fa';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Cell } from 'recharts';
import { customFetch } from '../utils';

const InsurancePageSalesByName = () => {
  ...
  const fetchStats = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const res = await customFetch.get('detailed-sales/insurance-detailed/sales-by-name', {
        params: month
          ? {
              year: month.split('-')[0],
              month: month.split('-')[1],
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-3xl font-bold text-primary flex items-center gap-2">
          ...
          Insurance Sales by Sales Person
        </h1>
      </div>
          ...
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              <div className="stat bg-base-200 rounded-lg p-4">
                ...
                <div className="stat-value text-2xl">{summary?.totalSalesPersons || 0}</div>
              </div>
              <div className="stat bg-base-200 rounded-lg p-4">
                  ...
                  {stats.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4" className="text-center py-8">
                        <p className="text-base-content/70">No insurance sales by sales person available.</p>
                      </td>
                    </tr>
                  )}
                </tbody>
...
export default InsurancePageSalesByName;
